...
const Header = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('wishlistUpdated', fetchWishlistCount); // ADD THIS

    return () => {
      window.removeEventListener('cartUpdated', fetchCartCount);
      window.removeEventListener('wishlistUpdated', fetchWishlistCount); // ADD THIS
    };
  }, []);
    ...
    <header className="main-header">
      <div className="header-container">
        ...
        <div className="header__actions">
          {/* Show cart and wishlist only when logged in */}
          {isLoggedIn && (
            <>
              <button
          ...
          {/* Show login button when not logged in, show user menu when logged in */}
          {!isLoggedIn ? (
